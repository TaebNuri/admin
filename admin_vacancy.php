...
if(isset($_GET['email'])){
    include '_db_connection.php';
    $email = $_GET['email'];
    $delete = mysqli_query($conn,"DELETE FROM `candidates` WHERE `email`='$email'");
            ...
            <table width="100%">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td class="active">
                            <p><?php 
                                echo "<a href = 'admin_vacancy_details.php?title=".$row['title']."' class='btn''><b>Details</b></a>"; 
                                ?></p>
                        </td>
